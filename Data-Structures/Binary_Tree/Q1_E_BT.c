...
{
    /* add your code here */
    /* 2개의 이진 트리가 동일하면 1 반환 아니면 0 반환
     둘다 비어도 동일취급 1반환 */

    /* 재귀적으로 둘의 identical을 확인해야함
        둘다 null이면 동일
        하나만 null이거나 노드값 다르면 0 리턴
        and연산해서 하나라도 0이면 최종 0 리턴
    */
...
BTNode *pop(Stack *stk)
{
    ...
    {
        temp = top->next;
        ptr = top->btnode; // top의 노드 포인터를 반환
